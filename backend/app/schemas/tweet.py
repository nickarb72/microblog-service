...
class MediaFileForm:
    ...
    def __init__(
        self, file: UploadFile = File(..., description="Image file (JPEG, PNG) max 5MB")
    ):
        self.file = file
...
class TweetResponse(BaseModel):
    ...
    content: str = Field(..., example="Hello world!", max_length=MAX_TEXT_SIZE)
